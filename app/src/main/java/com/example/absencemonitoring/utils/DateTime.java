...
public class DateTime {
    ...
    public static String calculateAmountIsDayOrHour(String amount) {
        String[] amounts = amount.split(":");
        if (amounts[0].equals("00")) {
            return Formating.englishDigitsToPersian(amounts[1]) + ":" + Formating.englishDigitsToPersian(amounts[2]) + " ساعت";
        } else {
            return Formating.englishDigitsToPersian(amounts[0]) + " روز";
        }
    }
